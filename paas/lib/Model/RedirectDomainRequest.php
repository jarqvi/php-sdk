...
/**
 * RedirectDomainRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RedirectDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'redirectDomain_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['redirect_status'] === null) {
            $invalidProperties[] = "'redirect_status' can't be null";
        }
     ...
     *
     * @param float $redirect_status 302 or 301
     *
     * @return self
     */
