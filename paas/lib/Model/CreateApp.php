...
class CreateApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of app that you want to create
     *
     * @return self
     */
     ...
     * Sets plan_id
     *
     * @param string|null $plan_id The plan of app that you want to create
     *
     * @return self
     */
     ...
     * Sets platform
     *
     * @param string|null $platform The platform of app that you want to create
     *
     * @return self
     */
