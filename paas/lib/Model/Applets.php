 ...
 */
class Applets implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Applets';
    ...
    protected static $openAPITypes = [
        'applets' => '\OpenAPI\Client\Model\AppletsAppletsInner[]'
    ];
    ...
    {
        $this->setIfExists('applets', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets applets
     *
     * @return \OpenAPI\Client\Model\AppletsAppletsInner[]|null
     */
    public function getApplets()
    {
        return $this->container['applets'];
    }

    /**
     * Sets applets
     *
     * @param \OpenAPI\Client\Model\AppletsAppletsInner[]|null $applets applets
     *
     * @return self
     */
    ...
    {
        if (is_null($applets)) {
            throw new \InvalidArgumentException('non-nullable applets cannot be null');
        }
        $this->container['applets'] = $applets;
